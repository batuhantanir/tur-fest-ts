    ...
    <div className="flex justify-center relative w-full h-fit mt-[90px] md:mt-0 md:h-[800px]">
      ...
      >
        <div className="mb-6 border-b pb-2">
          ...
          />
          <div
            className={`bg-white ${searchTerm && "border"} rounded-lg border-cst-primary group-focus-within:flex max-h-[300px] overflow-auto w-full text-cst-primary absolute hidden flex-col top-10`}
          >
            ...
            {error
              ...
              : results.map((item, index) => (
                  <span
                    key={index}
                    className="text-cst-primary py-2 pl-4"
                  >
                    {item}
                  </span>
                ))}
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              {items.map((item, index) => (
                <div div className="flex gap-2 flex-nowrap" key={index}>
                  <Checkbox id={item.id} />
